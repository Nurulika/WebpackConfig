// src/lib.rs
/*
 * Core library for WebpackConfig
 */
...
#[derive(Debug)]
pub struct WebpackConfigProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WebpackConfigProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WebpackConfig processing");
    
    let mut processor = WebpackConfigProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WebpackConfigProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WebpackConfigProcessor::new(false);
